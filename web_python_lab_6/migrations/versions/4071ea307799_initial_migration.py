...
Revision ID: 4071ea307799
Revises: 
Create Date: 2026-02-05 18:35:29.822784
...
def downgrade():
    ...
    # ### end Alembic commands ###
    op.execute("DELETE FROM categories WHERE name IN ('Программирование', 'Математика', 'Языкознание')")